...
{	
	...
	public MainWindow (): base (Gtk.WindowType.Toplevel)
	{
		...
		//new TreeCellDataFunc(delegate(TreeViewColumn tree_column, CellRenderer cell,TreeModel tree_model, TreeIter IconThemeError){
	...
	private void fillListStore() {
		...
		dbCommand.CommandText = "select a.id, a.nombre, c.nombre as categoria, a.precio from articulo a left join categoria c on a.categoria = c.id";
